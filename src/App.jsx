      ...
      <Router>
        <TeamDraftProvider>
          ...
          <Routes>
            ...
            <Route path="/video-confirmation" element={<SubmissionConfirmation type="video" />} />
            <Route path="/pdf-confirmation" element={<SubmissionConfirmation type="pdf" />} />
            <Route path="/pdf-submission/:teamId" element={<StepperFormPdf />} />
            <Route path="/submission/cdx/:teamId" element={<CDXSubmissionPage />} />
