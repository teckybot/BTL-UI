...
export default function EventsTimeline() {
  const events = [
    ...
    { date: "16 Nov 2025", title: "Registration close", desc: "Enrollment will end after the registration deadline. No entries will be accepted beyond the cut-off." },
    { date: "16 Nov 2025", title: "Qualifier level close", desc: "All team submissions will be finalized and reviewed. No edits or uploads will be allowed post deadline." },
    { date: "30 Nov 2025", title: "Results of Qualifier level", desc: "Selected teams will move forward to the grand stage. Results will be officially published after evaluation." },
    { date: "14 Dec 2025", title: "Finale", desc: "Finalists will compete for the BTL championship title, showcasing creativity and teamwork on the grand stage." },
  ];
