...
export default function Innoverse() {
  ...
  const customTitle = "Submissions Opening Soon! 🚀";
  const customMessage = "Thank you for your interest. PDF submissions for this competition will be opening shortly. Please check back later!";
            ...
            <div className="relative bg-white border border-gray-300 shadow-xl rounded-lg p-4 sm:p-6  md:p-[100px] sm:mb-[40px] md:mt-[-45px] max-h-[75vh] overflow-y-auto scrollbar-thin scrollbar-thumb-[#2053CA]/70 scrollbar-track-gray-200">
              ...
              <ul className="list-disc pl-5 space-y-2 text-[15px] text-gray-700 text-justify">
                ...
                <ul className="list-[circle] pl-5 mt-1 space-y-1">
                  ...
                  <li>
                    Upload your PDF at: <a href="https://www.bharatteckleague.com/competitions/innoverse" target="_blank" rel="noreferrer" className="text-blue-700 underline">https://www.bharatteckleague.com/competitions/innoverse</a>
                  </li>
