...
//       <div className="hidden md:block relative min-h-screen bg-black text-white overflow-hidden">
//         {/* Video Background */}
...
//           >
//             <source src="/videos/BTL 2025 Launch Video Final.mp4" type="video/mp4" />
//             <img
//               src="/images/about-fallback.jpg"
...
//       <div className="block md:hidden relative min-h-screen bg-black text-white">
//         {/* Image Background */}
//         <div className="absolute inset-0 z-0">
//           <img
//             src={bgImageMobile}
...
//           <h1 className="text-3xl mt-[30vh] font-extrabold tracking-wider uppercase text-white">
//             BTL 2025
//           </h1>

//           <div className="mt-8 bg-white/10 p-4 rounded-xl text-sm leading-relaxed text-gray-100 shadow-md border border-white/10 mx-4">
//             <p>
//               Bharat Tech League (BTL) by Teckybot is a national initiative that nurtures innovation and technical skills among young minds through engaging competitions across India.
//             </p>
//           </div>
//         </div>
//       </div>
