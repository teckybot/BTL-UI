...
import orbit from '../../../data/Orbit_background.png';
...
export default function SchoolRegistrationCard() {
    ...
    return (
        <div className="relative w-[400px] h-[560px] -mt-10 bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col">
            {/* Header */}
